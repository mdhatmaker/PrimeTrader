...
namespace PrimeTrader
{
    public partial class SettingsForm : Form
    {
        ...
        private void btnBenchmarkTool_Click(object sender, EventArgs e)
        {
            ...
            if (MainPrimeTraderForm.Forms["IQFeedSettingsForm"] == null) MainPrimeTraderForm.Forms["IQFeedSettingsForm"] = new IQFeed.IQFeedSettingsForm();
        ...
        public Form CreateForm(string name)
        {
            if (name == "HistoricalDataForm")
                MainPrimeTraderForm.Forms[name] = new IQFeed.HistoricalDataForm();
            else if (name == "StreamingBarsForm")
                MainPrimeTraderForm.Forms[name] = new IQFeed.StreamingBarsForm();
            else if (name == "PricesForm")
                MainPrimeTraderForm.Forms[name] = new IQFeed.PricesForm();
